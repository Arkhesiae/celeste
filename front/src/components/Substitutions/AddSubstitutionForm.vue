...
<template>
        ...
        <v-window-item :value="0">
          ...
          >
            ...
            <v-card-text class="">
              ...
              <v-chip-group
                v-else
                v-model="acceptedSwitches"
                multiple
                color="surface"
                :rules="[rules.rotations]"
              >
                <div
                  v-for="day in rotationDays"
                  :key="day._id"
              ...
              <div
                v-if="acceptedSwitches.length > 0"
                class="mt-4 d-flex flex-column "
              >
                <div
                  v-for="switchDay in acceptedSwitches"
                  :key="switchDay"
                >
                  <div
                    v-if="!isSwitchAvailable(switchDay)"
                  ...
                  >
                    ...
                    <div class="text-error d-flex align-center ga-2">
                      ...
                      >{{ getUnavailabilityReason(switchDay) }}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <v-window-item :value="1">
          ...
          <template v-else>
            <v-form ref="addForm">
              ...
              <div
                v-if="acceptedSwitchesWithPoints.length > 0"
                class="d-flex flex-column ga-4 my-8"
              >
                <div
                  v-for="switchDay in acceptedSwitches"
                  :key="switchDay"
              ...
              <div
                v-if="dialogMode !== 'switch'"
                class="d-flex justify-start flex-column align-start mt-4"
              >
                <div
                  v-if="acceptedSwitchesWithPoints.length > 0"
                  class="mb-4 pl-4"
  ...
  <PointsDialog
    :is-dialog-visible="showPointsDialog"
    :points="switchPoints"
    :switch="switchToEdit"
    @update:is-dialog-visible="showPointsDialog = $event"
  ...
  <ConfirmationDialog
    ...
    :confirm-text="'Poster quand même'"
