      ...
      <v-card-text class="pa-0 my-4 ma-0">
        ...
        <template v-if="currentChange">
          ...
          >
              ...
              <v-col cols="12">   
                ...
                >
                  <div class="d-flex flex-wrap flex-column ga-1">
                    <div
                      v-for="daySlot in maxRotationDays(currentChange)"
                      :key="daySlot"
                    >
            ...
            <v-chip
              v-if="differentLength(currentChange)"
              color="error"
              variant="tonal"
              class=""
              size="x-small"
            ...
            <div
              v-if="differentLength(currentChange)"
              class="d-flex align-center justify-center ga-2 my-2"
            ...
            >
              <v-chip
                ...
                :color="differentLength(currentChange) ? 'error' : 'remplacement'"
                variant="tonal"
                rounded="xl"
              >
