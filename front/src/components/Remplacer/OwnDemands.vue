<template>
    ...
    <div class="d-flex align-start flex-column justify-space-between mb-4">
      <v-fade-transition mode="out-in">
        <v-card-title :key="currentTitle" class="text-h6 font-weight-medium pa-0 mb-0">
          {{ currentTitle }}
        </v-card-title>
      </v-fade-transition>
      <v-slide-x-transition mode="out-in">
        <span :key="currentSubtitle" class="text-subtitle-2 text-medium-emphasis">
    ...
    <!-- Section "En attente" -->
    <div v-if="showPendingSection" class="mb-4 d-flex flex-column">
      <v-expand-transition>
    ...
    <div v-if="showUpcomingSection" class="mb-4 d-flex flex-column">
    ...
    <div v-if="showReplacementSection" class="mb-4 d-flex flex-column">
