  ...
  >
    ...
    <div class="d-flex align-center justify-center ">
      <div
        ...
        class="flex-1-1 d-flex align-center justify-center mb-4 pa-6"
      >
        <v-btn
          value="option2"
          variant="flat"
        ...
        <v-btn
          ...
          height="60px"
          variant="flat"
          class="flex-1-1 d-flex flex-column rounded-te-xl rounded-be-xl text-none "
          rounded="lg"
          @click="promptDialog('Renfort')"
        >
          <template #prepend>
    ...
    <v-card-text class="pa-0">
      ...
      >
        <v-scroll-x-transition mode="out-in">
          <div>
            <TeamOccurence
              v-for="nextOccurrence in nextOccurrences"
              :key="nextOccurrence._id"
