<template>
  ...
  >
    ...
    <div
      ...
      class="d-flex align-center ga-2 mb-4 px-4"
    >
      <v-btn
        height="36px"
    ...
    >
      <v-btn
        ...
        @click="$emit('cancelDemand', substitutionId)"
      >
        Annuler ma demande
      </v-btn>
    </div>
    ...
    >
      <v-chip
        ...
        color="remplacement"
        variant="flat"
        class="text-caption font-weight-bold px-4 mr-3"
      >
    ...
    <v-btn
      width="100%"
      :class="{ 'opacity-10': substitutionStore.countAvailableSwitches(selectedDate) === 0 }"
      flat
      rounded="xl"
      height="64px"
      color="background"
    ...
    <v-btn
      width="100%"
      :class="{ 'opacity-10': substitutionStore.countOtherDemands(selectedDate) === 0 }"
      flat
      rounded="xl"
      height="64px"
      color="background"
      ...
      class="justify-space-between d-flex text-medium-emphasis text-subtitle-2"
      @click="$emit('openDrawer', 'others')"
    >
      <v-chip
        rounded="xl"
