      ...
      <v-col cols="12">
        <v-card rounded="xl" elevation="0" class="pa-6" color="surfaceContainer">
          ...
          <v-card-text class="d-flex flex-column ga-4">
            <!-- Impact Light -->
            <v-btn block height="64" class="rounded-lg py-4" color="primary" elevation="0" @click="triggerImpactLight">
              <v-icon class="mr-3">
                mdi-hand-front
              </v-icon>
            ...
            <!-- Impact Medium -->
            <v-btn block height="64" class="rounded-lg py-4" color="primary" elevation="0" @click="triggerImpactMedium">
              <v-icon class="mr-3">
                mdi-hand-front
              </v-icon>
            ...
            <!-- Impact Heavy -->
            <v-btn block height="64" class="rounded-lg py-4" color="primary" elevation="0" @click="triggerImpactHeavy">
              <v-icon class="mr-3">
                mdi-hand-front
              </v-icon>
            ...
            <!-- Impact Rigid -->
            <v-btn block height="64" class="rounded-lg py-4" color="primary" elevation="0" @click="triggerImpactRigid">
              <v-icon class="mr-3">
                mdi-hand-front
              </v-icon>
            ...
            <!-- Impact Soft -->
            <v-btn block height="64" class="rounded-lg py-4" color="primary" elevation="0" @click="triggerImpactSoft">
              <v-icon class="mr-3">
                mdi-hand-front
              </v-icon>
        ...
        <v-card rounded="xl" elevation="0" class="pa-6 mt-4" color="surfaceContainer">
          ...
          <v-card-text class="d-flex flex-column ga-4">
            ...
            <v-btn
block height="64" class="rounded-lg py-4" color="success" elevation="0"
            ...
            <v-btn
block height="64" class="rounded-lg py-4" color="warning" elevation="0"
            ...
            <!-- Notification Error -->
            <v-btn
block height="64" class="rounded-lg py-4" color="error" elevation="0"
        ...
        <v-card rounded="xl" elevation="0" class="pa-6 mt-4" color="surfaceContainer">
          ...
          <v-card-text class="d-flex flex-column ga-4">
            <!-- Selection -->
            <v-btn block height="64" class="rounded-lg py-4" color="info" elevation="0" @click="triggerSelectionStart">
              <v-icon class="mr-3">
                mdi-cursor-pointer
              </v-icon>
            ...
            <v-btn
block height="64" class="rounded-lg py-4" color="info" elevation="0"
            ...
            <v-btn block height="64" class="rounded-lg py-4" color="info" elevation="0" @click="triggerSelectionEnd">
              <v-icon class="mr-3">
                mdi-cursor-pointer
              </v-icon>
        ...
        <v-card rounded="xl" elevation="0" class="pa-6 mt-4" color="surfaceContainer">
          ...
          <v-card-text class="d-flex flex-column ga-4">
            <!-- Vibrate -->
            <v-btn block height="64" class="rounded-lg py-4" color="secondary" elevation="0" @click="triggerVibrate">
              <v-icon class="mr-3">
                mdi-vibrate
              </v-icon>
            ...
            <v-btn
block height="64" class="rounded-lg py-4" color="secondary" elevation="0"
            ...
            <!-- Impact Ultra-Léger -->
            <v-btn block height="64" class="rounded-lg py-4" color="secondary" elevation="0" @click="triggerUltraLight">
              <v-icon class="mr-3">
                mdi-feather
              </v-icon>
            ...
            <!-- Tap Léger -->
            <v-btn block height="64" class="rounded-lg py-4" color="secondary" elevation="0" @click="triggerLightTap">
              <v-icon class="mr-3">
